 ...
 *
 * Tests the actual MockPluginChannel (from @moli-code/channel-plugin-example) connected
 ...
 *           → moli-code --acp (REAL model request)
...
describe('Channel Plugin (Mock WebSocket E2E)', () => {
  ...
  const setup = async () => {
    ...
    // 2. Start AcpBridge (spawns real moli-code --acp)
