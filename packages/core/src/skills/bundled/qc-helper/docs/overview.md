...
- **Build features from descriptions**: Tell Moli Code what you want to build in plain language. It will make a plan, write the code, and ensure it works.
