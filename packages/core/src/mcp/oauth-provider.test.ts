...
describe('MCPOAuthProvider', () => {
  ...
  describe('Authorization URL building', () => {
    ...
    // Regression test for https://github.com/dimoteo333/moli-code/issues/1749
    // Scenario: user runs `moli mcp add --transport http yuque https://mcp.alibaba-inc.com/yuque/mcp`
