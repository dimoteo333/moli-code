...
async function getGeminiMdFilePathsInternalForEachDir(
  ...
  for (const geminiMdFilename of geminiMdFilenames) {
    ...
    if (isHomeDirectory) {
      // For home directory, only check for context files (MOLI.md, AGENTS.md, QWEN.md) directly in the home directory
...
/**
 * Loads hierarchical context files (MOLI.md, AGENTS.md, QWEN.md) files and concatenates their content.
