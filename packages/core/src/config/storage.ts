...
export const SKILL_PROVIDER_CONFIG_DIRS = ['.moli', '.agents'];
...
export class Storage {
   ...
   *              Pass the project root so that relative values like ".moli" resolve
  ...
  /**
   * Returns the user-level extensions directory (~/.moli/extensions/).
   * Extensions installed at user scope are stored here, as opposed to
   * project-level extensions which live in <project>/.moli/extensions/.
   */
