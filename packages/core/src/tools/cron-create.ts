    ...
    try {
      ...
      if (recurring) {
        llmContent =
          ...
          'Session-only (not written to disk, dies when Moli Code exits). ' +
  ...
  constructor(private config: Config) {
    super(
      ...
      'Schedule a prompt to be enqueued at a future time. Use for both recurring schedules and one-shot reminders.\n\n' +
        ...
        '## Session-only\n\n' +
        'Jobs live only in this Moli Code session — nothing is written to disk, and the job is gone when Moli Code exits.\n\n' +
        '## Runtime behavior\n\n' +
