  ...
  const mockSkills: SkillConfig[] = [
    {
      ...
      level: 'project',
      filePath: '/project/.moli/skills/code-review/SKILL.md',
    ...
    },
    {
      ...
      level: 'user',
      filePath: '/home/user/.moli/skills/testing/SKILL.md',
      ...
      const newSkills: SkillConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.moli/skills/new-skill/SKILL.md',
      ...
      const newSkills: SkillConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.moli/skills/test-skill/SKILL.md',
          body: 'Test content.',
        },
      ];
  ...
  describe('SkillToolInvocation', () => {
    ...
    it('should execute skill load successfully', async () => {
      ...
      expect(llmText).toContain(
        'Base directory for this skill: /project/.moli/skills/code-review',
      );
