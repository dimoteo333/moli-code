...
export interface LSToolParams {
  ...
  /**
   * Whether to respect .gitignore and .moliignore patterns (optional, defaults to true)
   */
    ...
    super(
      ...
      Kind.Search,
      {
        properties: {
          ...
          file_filtering_options: {
            description:
              'Optional: Whether to respect ignore patterns from .gitignore or .moliignore',
            type: 'object',
            properties: {
              respect_git_ignore: {
                description:
