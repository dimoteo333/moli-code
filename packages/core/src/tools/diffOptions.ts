...
type DefaultDiffOptions = Omit<CreatePatchOptionsNonabortable, 'callback'> &
  Omit<StructuredPatchOptionsNonabortable, 'callback'>;

export const DEFAULT_DIFF_OPTIONS: DefaultDiffOptions = {
  context: 3,
