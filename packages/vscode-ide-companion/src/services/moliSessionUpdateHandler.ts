...
/**
 * Moli Session Update Handler class
 * Processes various session update events and calls appropriate callbacks
 */
export class MoliSessionUpdateHandler {
  private callbacks: MoliAgentCallbacks;

  constructor(callbacks: MoliAgentCallbacks) {
   ...
   */
  updateCallbacks(callbacks: MoliAgentCallbacks): void {
    this.callbacks = callbacks;
  }
  ...
  handleSessionUpdate(data: SessionNotification): void {
    ...
    switch (sessionUpdate) {
      ...
      default:
        console.log('[MoliAgentManager] Unhandled session update type');
        break;
    }
  }
