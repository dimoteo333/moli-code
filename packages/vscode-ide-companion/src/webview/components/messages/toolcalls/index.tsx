 ...
 * All UI components are now imported from @dobby/moli-code-webui
 */
...
import type { BaseToolCallProps } from '@dobby/moli-code-webui';
...
export type { BaseToolCallProps, ToolCallData } from '@dobby/moli-code-webui';
