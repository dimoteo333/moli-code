...
async function main() {
  ...
  const webviewCtx = await esbuild.context({
    ...
    // @dobby/moli-code-core is a peer dependency of @dobby/moli-code-webui.
    // Since @dobby/moli-code-webui marks it as external in its own Vite build, the
    ...
    // '@dobby/moli-code-core/src/core/tokenLimits.js') are also excluded;
    ...
    external: ['@dobby/moli-code-core', '@dobby/moli-code-core/*'],
    logLevel: 'silent',
