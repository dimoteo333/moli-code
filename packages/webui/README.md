# @dobby/moli-code-webui

A shared React component library for Moli Code applications, providing cross-platform UI components with consistent styling and behavior.
...
```bash
npm install @dobby/moli-code-webui
```
...
<html>
  <head>
    ...
    <script src="https://unpkg.com/@dobby/moli-code-webui@0.1.0-beta.2/dist/index.umd.js"></script>

    <!-- Load the CSS -->
    <link
      rel="stylesheet"
      href="https://unpkg.com/@dobby/moli-code-webui@0.1.0-beta.2/dist/styles.css"
    />
  </head>
  <body>
    <div id="root"></div>
    ...
    <script type="text/babel">
      // Access components from the global MoliCodeWebUI object
      const { ChatViewer } = MoliCodeWebUI;
...
```tsx
import { Button, Input, Tooltip } from '@dobby/moli-code-webui';
import { PlatformProvider } from '@dobby/moli-code-webui/context';
...
```tsx
import { Button } from '@dobby/moli-code-webui';
...
```tsx
import { Input } from '@dobby/moli-code-webui';
...
```tsx
import { Tooltip } from '@dobby/moli-code-webui';
...
```tsx
import { FileIcon, FolderIcon, CheckIcon } from '@dobby/moli-code-webui/icons';
...
```tsx
import { PlatformProvider, usePlatform } from '@dobby/moli-code-webui/context';
...
// tailwind.config.js
module.exports = {
  presets: [require('@dobby/moli-code-webui/tailwind.preset.cjs')],
  // your customizations
};
```
