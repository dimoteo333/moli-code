...
<html>
  <head>
    ...
    <script src="https://unpkg.com/@moli-code/webui@0.1.0-beta.2/dist/index.umd.js"></script>

    <!-- Load the CSS -->
    <link
      rel="stylesheet"
      href="https://unpkg.com/@moli-code/webui@0.1.0-beta.2/dist/styles.css"
    />
  </head>
  <body>
    <div id="root"></div>
...
```tsx
import { Button, Input, Tooltip } from '@moli-code/webui';
import { PlatformProvider } from '@moli-code/webui/context';
...
```tsx
import { Button } from '@moli-code/webui';
...
```tsx
import { Input } from '@moli-code/webui';
...
```tsx
import { Tooltip } from '@moli-code/webui';
...
```tsx
import { FileIcon, FolderIcon, CheckIcon } from '@moli-code/webui/icons';
...
```tsx
import { PlatformProvider, usePlatform } from '@moli-code/webui/context';
...
// tailwind.config.js
module.exports = {
  presets: [require('@moli-code/webui/tailwind.preset.cjs')],
  // your customizations
};
```
