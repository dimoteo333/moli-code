...
1. Extract components from `vscode-ide-companion/src/webview/` into an independent `@dobby/moli-code-webui` package
...
```typescript
// @dobby/moli-code-webui/src/context/PlatformContext.ts
...
```javascript
// @dobby/moli-code-webui/tailwind.preset.js
module.exports = {
  theme: {
    extend: {
      colors: {
...
module.exports = {
  presets: [require('@dobby/moli-code-webui/tailwind.preset')],
  content: [
    './src/**/*.{ts,tsx}',
    './node_modules/@dobby/moli-code-webui/dist/**/*.js',
  ],
};
```
...
```
Developer ──► @dobby/moli-code-webui ──► vscode-ide-companion
  │              │                      │
...
// After: Update import
import { FileIcon } from '@dobby/moli-code-webui';
// or import { FileIcon } from '@dobby/moli-code-webui/icons';
```
...
1. **Tailwind Class Name Tree Shaking**
   ...
   - Solution: Consumer's `content` config needs to include `node_modules/@dobby/moli-code-webui`
...
│     └── Edit files in @dobby/moli-code-webui/src/                     │
│                                                                  │
...
│     └── import { Component } from '@dobby/moli-code-webui'            │
...
1. **Single Source of Truth**: All UI components live in `@dobby/moli-code-webui`
