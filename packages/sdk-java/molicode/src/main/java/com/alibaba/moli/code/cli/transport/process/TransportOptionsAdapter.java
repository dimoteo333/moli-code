...
class TransportOptionsAdapter {
    ...
    String[] buildCommandArgs() {
        List<String> args = new ArrayList<>(
                Arrays.asList(transportOptions.getPathToMoliExecutable(), "--input-format", "stream-json", "--output-format",
    ...
    private TransportOptions addDefaultTransportOptions(TransportOptions userTransportOptions) {
        ...
        if (StringUtils.isBlank(transportOptions.getPathToMoliExecutable())) {
            transportOptions.setPathToMoliExecutable("moli");
        }
