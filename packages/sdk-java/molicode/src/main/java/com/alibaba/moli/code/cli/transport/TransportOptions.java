...
public class TransportOptions implements Cloneable {
    /**
     * Path to the Moli executable.
     */
    private String pathToMoliExecutable;
    /**
    ...
    /**
     * Gets the path to the Moli executable.
     *
     * @return The path to the Moli executable
     */
    public String getPathToMoliExecutable() {
        return pathToMoliExecutable;
    }

    /**
     * Sets the path to the Moli executable.
     *
     * @param pathToMoliExecutable The path to the Moli executable
     * @return This instance for method chaining
     */
    public TransportOptions setPathToMoliExecutable(String pathToMoliExecutable) {
        this.pathToMoliExecutable = pathToMoliExecutable;
        return this;
    }
