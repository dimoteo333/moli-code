package com.alibaba.moli.code.cli.session.event.consumers;

import java.util.List;
import java.util.Optional;

import com.alibaba.moli.code.cli.protocol.data.AssistantContent;
import com.alibaba.moli.code.cli.protocol.data.AssistantContent.TextAssistantContent;
import com.alibaba.moli.code.cli.protocol.data.AssistantContent.ThingkingAssistantContent;
import com.alibaba.moli.code.cli.protocol.data.AssistantContent.ToolResultAssistantContent;
import com.alibaba.moli.code.cli.protocol.data.AssistantContent.ToolUseAssistantContent;
import com.alibaba.moli.code.cli.protocol.data.AssistantUsage;
import com.alibaba.moli.code.cli.protocol.data.behavior.Allow;
import com.alibaba.moli.code.cli.protocol.data.behavior.Behavior;
...
import com.alibaba.moli.code.cli.protocol.message.assistant.block.ContentBlock;
import com.alibaba.moli.code.cli.protocol.message.assistant.event.ContentBlockDeltaEvent;
import com.alibaba.moli.code.cli.protocol.message.assistant.event.StreamEvent;
import com.alibaba.moli.code.cli.protocol.message.control.payload.CLIControlPermissionRequest;
import com.alibaba.moli.code.cli.protocol.message.control.payload.CLIControlPermissionResponse;
...
import com.alibaba.moli.code.cli.session.Session;
...
public class SessionEventSimpleConsumers implements SessionEventConsumers {
     ...
     *
     * @param session a {@link com.alibaba.moli.code.cli.session.Session} object.
     * @param assistantContent a {@link com.alibaba.moli.code.cli.protocol.data.AssistantContent} object.
     */
