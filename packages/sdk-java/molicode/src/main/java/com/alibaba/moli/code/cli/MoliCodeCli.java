...
import com.alibaba.moli.code.cli.session.event.consumers.AssistantContentConsumers;
...
import com.alibaba.moli.code.cli.transport.process.ProcessTransport;
...
/**
 * Main entry point for interacting with the Moli Code CLI. Provides static methods for simple queries and session management.
 *
 * @author skyfire
 * @version $Id: 0.0.1
 */
public class MoliCodeCli {
    private static final Logger log = LoggerFactory.getLogger(MoliCodeCli.class);

    /**
     * Sends a simple query to the Moli Code CLI and returns a list of responses.
     *
