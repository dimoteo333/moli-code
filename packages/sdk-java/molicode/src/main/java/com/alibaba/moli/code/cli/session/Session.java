package com.alibaba.moli.code.cli.session;
...
import com.alibaba.moli.code.cli.protocol.data.Capabilities;
import com.alibaba.moli.code.cli.protocol.data.PermissionMode;
import com.alibaba.moli.code.cli.protocol.message.SDKResultMessage;
import com.alibaba.moli.code.cli.protocol.message.SDKSystemMessage;
import com.alibaba.moli.code.cli.protocol.message.SDKUserMessage;
import com.alibaba.moli.code.cli.protocol.message.assistant.SDKAssistantMessage;
import com.alibaba.moli.code.cli.protocol.message.assistant.SDKPartialAssistantMessage;
import com.alibaba.moli.code.cli.protocol.message.control.payload.CLIControlInitializeRequest;
import com.alibaba.moli.code.cli.protocol.message.control.payload.CLIControlInitializeResponse;
import com.alibaba.moli.code.cli.protocol.message.control.payload.CLIControlInterruptRequest;
import com.alibaba.moli.code.cli.protocol.message.control.CLIControlRequest;
import com.alibaba.moli.code.cli.protocol.message.control.CLIControlResponse;
import com.alibaba.moli.code.cli.protocol.message.control.payload.CLIControlSetModelRequest;
import com.alibaba.moli.code.cli.protocol.message.control.payload.CLIControlSetPermissionModeRequest;
import com.alibaba.moli.code.cli.protocol.message.control.payload.ControlRequestPayload;
import com.alibaba.moli.code.cli.protocol.message.control.payload.ControlResponsePayload;
import com.alibaba.moli.code.cli.session.event.consumers.SessionEventConsumers;
import com.alibaba.moli.code.cli.session.exception.SessionControlException;
import com.alibaba.moli.code.cli.session.exception.SessionSendPromptException;
import com.alibaba.moli.code.cli.transport.Transport;
import com.alibaba.moli.code.cli.transport.TransportOptions;
import com.alibaba.moli.code.cli.utils.MyConcurrentUtils;
import com.alibaba.moli.code.cli.utils.Timeout;
...
/**
 * Manages a session with the Moli Code CLI, handling communication, sending prompts, and processing responses.
 *
 * @author skyfire
 * @version $Id: 0.0.1
 */
public class Session {
     ...
     * @throws com.alibaba.moli.code.cli.session.exception.SessionControlException if the transport is not available
     */
     ...
     *
     * @throws com.alibaba.moli.code.cli.session.exception.SessionControlException if initialization fails
     */
     ...
     *
     * @throws com.alibaba.moli.code.cli.session.exception.SessionControlException if closing fails
     */
     ...
     * @throws com.alibaba.moli.code.cli.session.exception.SessionControlException if the operation fails
     */
     ...
     * @throws com.alibaba.moli.code.cli.session.exception.SessionSendPromptException if sending the prompt fails
     * @throws com.alibaba.moli.code.cli.session.exception.SessionControlException if a control operation fails
     */
