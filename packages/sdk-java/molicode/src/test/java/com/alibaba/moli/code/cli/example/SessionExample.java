package com.alibaba.moli.code.cli.example;
...
import com.alibaba.moli.code.cli.protocol.message.assistant.block.TextBlock;
...
public class SessionExample {
    ...
    public static void runSetModelExample(Session session) {
        try {
            ...
            Optional<Boolean> modelChangeResult = session.setModel("moli3-coder-flash");
            ...
            Optional<Boolean> modelChangeResult2 = session.setModel("moli3-coder-plus");
