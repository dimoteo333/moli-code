...
vi.mock('@dobby/moli-code-core', async () => {
  const actual = await vi.importActual<typeof import('@dobby/moli-code-core')>(
...
import { read as readJsonlFile } from '@dobby/moli-code-core';
    ...
    it('should aggregate satisfaction counts', () => {
      const facets: SessionFacets[] = [
        ...
        },
        {
          ...
          Moli_helpfulness: 'moderately_helpful',
    ...
    it('should aggregate primary success excluding none', () => {
      const facets: SessionFacets[] = [
        ...
        },
        {
          ...
          user_satisfaction_counts: {},
          Moli_helpfulness: 'slightly_helpful',
