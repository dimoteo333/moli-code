 ...
 * CLI commands (like `moli extensions list`) where the output IS the user-facing
 * result, not debug logging.
 *
 * For debug/diagnostic logging, use `createDebugLogger()` from @dobby/moli-code-core.
 */
