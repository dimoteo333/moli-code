...
export default {
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Moli Code.':
    'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Moli Code.',
  ...
  'Tool operations will proceed without hook validation':
    'Tool operations will proceed without hook validation',
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Moli Code.':
    'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Moli Code.',
  // Hooks - Source
  Project: 'Project',
  User: 'User',
  ...
  'Right before Moli Code concludes its response':
    'Right before Moli Code concludes its response',
  ...
  Deny: 'Deny',
  Workspace: 'Workspace',
  "Moli Code won't ask before using allowed tools.":
    "Moli Code won't ask before using allowed tools.",
  'Moli Code will ask before using these tools.':
    'Moli Code will ask before using these tools.',
  'Moli Code is not allowed to use denied tools.':
    'Moli Code is not allowed to use denied tools.',
  ...
  'Moli Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'Moli Code can read files in the workspace, and make edits when auto-accept edits is on.',
  'Moli Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'Moli Code will be able to read files in this directory and make edits when auto-accept edits is on.',
  ...
  'Configure Qwen authentication information with Qwen-OAuth or Alibaba Cloud Coding Plan':
    'Configure Qwen authentication information with Qwen-OAuth or Alibaba Cloud Coding Plan',
  'Authenticate using Moli OAuth': 'Authenticate using Moli OAuth',
  ...
  'Authentication completed successfully.':
    'Authentication completed successfully.',
  'Starting Moli OAuth authentication...':
    'Starting Moli OAuth authentication...',
  'Successfully authenticated with Moli OAuth.':
    'Successfully authenticated with Moli OAuth.',
  'Failed to authenticate with Moli OAuth: {{error}}':
    'Failed to authenticate with Moli OAuth: {{error}}',
  ...
  '  moli auth                - Interactive authentication setup\n':
    '  moli auth                - Interactive authentication setup\n',
  ...
  '  Issue: API key not found in environment or settings\n':
    '  Issue: API key not found in environment or settings\n',
  '  Run `moli auth coding-plan` to re-configure.\n':
    '  Run `moli auth coding-plan` to re-configure.\n',
