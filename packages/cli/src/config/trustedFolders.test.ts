...
import { FatalConfigError, ideContextStore } from '@dobby/moli-code-core';
import {
  describe,
  it,
  expect,
...
describe('Trusted Folders Loading', () => {
  ...
  it('should use MOLI_CODE_TRUSTED_FOLDERS_PATH env var if set', () => {
    const customPath = '/custom/path/to/trusted_folders.json';
    process.env['MOLI_CODE_TRUSTED_FOLDERS_PATH'] = customPath;
    ...
    delete process.env['MOLI_CODE_TRUSTED_FOLDERS_PATH'];
  });
