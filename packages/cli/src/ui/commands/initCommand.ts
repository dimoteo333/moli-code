...
import { getCurrentGeminiMdFilename } from '@dobby/moli-code-core';
...
export const initCommand: SlashCommand = {
  name: 'init',
  get description() {
    return t('Analyzes the project and creates a tailored context file (MOLI.md, AGENTS.md, or QWEN.md).');
  },
  ...
  action: async (
    ...
    return {
      type: 'submit_prompt',
      content: `
You are Moli Code, an interactive CLI agent. Analyze the current directory and generate a comprehensive ${contextFileName} file to be used as instructional context for future interactions.
