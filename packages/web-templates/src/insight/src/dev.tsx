...
const MOCK_DATA: InsightData = {
  ...
  qualitative: {
    impressiveWorkflows: {
      intro:
        "You're a highly active Moli Code user with 314 sessions over 67 days, achieving strong results in test creation, PR workflows, and debugging with a 68% success rate on clear tasks.",
    ...
    improvements: {
      Moli_md_additions: [
        {
          ...
          prompt_scaffold:
            'Create new ## Code Review Standards section in MOLI.md',
        },
        {
          addition:
          ...
          prompt_scaffold:
            'Create new ## Testing Conventions section in MOLI.md',
        },
        {
          addition:
          ...
          prompt_scaffold: 'Create new ## PR Workflow section in MOLI.md',
        },
      ],
      features_to_try: [
        {
      ...
      usage_patterns: [
        ...
        },
        {
          ...
          copyable_prompt:
            'Create .moli/skills/pr/SKILL.md with your PR template requirements, then just type /pr',
        },
        {
