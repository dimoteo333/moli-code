...
3. Search for "Moli Code"
4. Click "Install"
5. Switch to the **Agent Server** tab and ensure Moli Code is enabled

Alternatively, you can install from the command line:

```bash
zed --install-extension moli-code
```

## Usage

1. Open the Agent Panel in Zed (`cmd-shift-a` on macOS or `ctrl-shift-a` on Linux/Windows)
2. Select "Moli Code" from the agent list
...
- Node.js >= 20 (for running Moli Code agent server)
