# Moli Code - Project Context

## Project Overview

**Moli Code** is an open-source AI agent for the terminal, optimized for [Moli3-Coder](https://github.com/MoliLM/Moli3-Coder). It helps developers understand large codebases, automate tedious work, and ship faster.

This project is based on [Google Gemini CLI](https://github.com/google-gemini/gemini-cli) with adaptations to better support Moli-Coder models.

### Key Features

- **OpenAI-compatible, OAuth free tier**: Use an OpenAI-compatible API, or sign in with Moli OAuth to get 1,000 free requests/day
...
#### `@dobby/moli-code-core` (packages/core/)
...
- **Models**: Model configuration and registry for Moli-Coder and OpenAI-compatible APIs
...
```bash
# Clone and install
git clone https://github.com/MoliLM/moli-code.git
cd moli-code
npm install
```
...
import { Config } from '@dobby/moli-code-core';
```
...
1. Default values
2. User settings (`~/.moli/settings.json`)
3. Project settings (`.moli/settings.json`)
4. Environment variables
5. CLI flags

### Authentication Methods

1. **Moli OAuth** (recommended): Browser-based OAuth flow
...
- User documentation: <https://molilm.github.io/moli-code-docs/>
