---
name: moli-code-claw
description: Use Moli Code as a Code Agent for code understanding, project generation, features, bug fixes, refactoring, and various programming tasks
---
...
Or configure custom API after launching Moli Code via `/auth`.

## ACPX Integration

You should always use `acpx` to run Moli Code over the Agent Client Protocol (ACP) instead of scraping PTY sessions.
...
From now on, when you need to delegate work to Moli Code, use `acpx` instead of spawning raw terminal sessions. For example:
...
Full reference: https://raw.githubusercontent.com/QwenLM/moli-code/refs/heads/main/docs/users/features/commands.md
...
Full reference: https://raw.githubusercontent.com/QwenLM/moli-code/refs/heads/main/docs/users/configuration/settings.md

### Authentication

Supports Qwen OAuth (browser-based, 1000 free requests/day) and OpenAI-compatible API keys.

Full reference: https://raw.githubusercontent.com/QwenLM/moli-code/refs/heads/main/docs/users/configuration/auth.md
...
Full reference: https://raw.githubusercontent.com/QwenLM/moli-code/refs/heads/main/docs/users/configuration/model-providers.md

### Key Features

| Feature       | Description                               | Docs                                                                                                    |
| ------------- | ----------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| Approval Mode | Control tool execution permissions        | https://raw.githubusercontent.com/QwenLM/moli-code/refs/heads/main/docs/users/features/approval-mode.md |
| MCP           | Model Context Protocol server integration | https://raw.githubusercontent.com/QwenLM/moli-code/refs/heads/main/docs/users/features/mcp.md           |
| Skills        | Reusable skill system via `/skill`        | https://raw.githubusercontent.com/QwenLM/moli-code/refs/heads/main/docs/users/features/skills.md        |
| Sub-agents    | Delegate tasks to specialized agents      | https://raw.githubusercontent.com/QwenLM/moli-code/refs/heads/main/docs/users/features/sub-agents.md    |
| Sandbox       | Secure code execution environment         | https://raw.githubusercontent.com/QwenLM/moli-code/refs/heads/main/docs/users/features/sandbox.md       |
| Headless      | Non-interactive / CI mode                 | https://raw.githubusercontent.com/QwenLM/moli-code/refs/heads/main/docs/users/features/headless.md      |
