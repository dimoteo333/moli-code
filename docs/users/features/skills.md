...
> Create, manage, and share Skills to extend Moli Code's capabilities.

This guide shows you how to create, use, and manage Agent Skills in **Moli Code**. Skills are modular capabilities that extend the model's effectiveness through organized folders containing instructions (and optionally scripts/resources).

## Prerequisites

- Moli Code (recent version)
- Basic familiarity with Moli Code ([Quickstart](../quickstart.md))
...
- Extend Moli Code for your workflows
...
## Instructions
Provide clear, step-by-step guidance for Moli Code.
...
Moli Code currently validates that:
...
If Moli Code doesn't use your Skill, check these common issues:
