...
> [!tip]
>
> You can quickly cycle through modes during a session using **Shift+Tab** (or **Tab** on Windows). The terminal status bar shows your current mode, so you always know what permissions Moli Code has.

## 1. Use Plan Mode for safe code analysis

Plan Mode instructs Moli Code to create a plan by analyzing the codebase with **read-only** operations, perfect for exploring codebases, planning complex changes, or reviewing code safely.

### When to use Plan Mode

- **Multi-step implementation**: When your feature requires making edits to many files
- **Code exploration**: When you want to research the codebase thoroughly before changing anything
- **Interactive development**: When you want to iterate on the direction with Moli Code
...
Default Mode is the standard way to work with Moli Code. In this mode, you maintain full control over all potentially risky operations - Moli Code will ask for your approval before making any file changes or executing shell commands.
...
- **Learning and teaching**: When you want to understand each step Moli Code is taking
...
Default Mode is the initial mode when you start Moli Code. If you've changed modes and want to return to Default Mode, use:
...
Moli Code will analyze your codebase and propose a plan. It will then ask for approval before:
...
Auto-Edit Mode instructs Moli Code to automatically approve file edits while requiring manual approval for shell commands, ideal for accelerating development workflows while maintaining system safety.
...
1. You ask Moli Code to refactor a function
...
YOLO Mode grants Moli Code the highest permissions, automatically approving all tool calls including file editing and shell commands.
