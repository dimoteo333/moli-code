# Github Actions：moli-code-action
...
This workflow acts as a central dispatcher for Moli Code CLI, routing requests to the appropriate workflow based on the triggering event and the command provided in the comment. For a detailed guide on how to set up the dispatch workflow, go to the [Moli Code Dispatch workflow documentation](./common-workflow).
...
### Moli Code CLI Assistant

This type of action can be used to invoke a general-purpose, conversational Moli Code AI assistant within the pull requests and issues to perform a wide range of tasks. For a detailed guide on how to set up the general-purpose Moli Code CLI workflow, go to the [Moli Code Assistant workflow documentation](./common-workflow).
...
- <a name="__input_qwen_cli_version"></a><a href="#user-content-__input_qwen_cli_version"><code>qwen*cli_version</code></a>: *(Optional, default: `latest`)\_ The version of the Moli Code CLI to install. Can be "latest", "preview", "nightly", a specific version number, or a git branch, tag, or commit. For more information, see [Moli Code CLI releases](https://github.com/dimoteo333/moli-code-action/blob/main/docs/releases.md).
...
- <a name="__input_prompt"></a><a href="#user-content-__input_prompt"><code>prompt</code></a>: _(Optional, default: `You are a helpful assistant.`)_ A string passed to the Moli Code CLI's [`--prompt` argument](https://github.com/dimoteo333/moli-code-action/blob/main/docs/cli/configuration.md#command-line-arguments).
...
- <a name="__input_settings"></a><a href="#user-content-__input_settings"><code>settings</code></a>: _(Optional)_ A JSON string written to `.moli/settings.json` to configure the CLI's _project_ settings.
  For more details, see the documentation on [settings files](https://github.com/dimoteo333/moli-code-action/blob/main/docs/cli/configuration.md#settings-files).
...
- <a name="__input_use_moli_code_assist"></a><a href="#user-content-__input_use_moli_code_assist"><code>use*moli_code_assist</code></a>: *(Optional, default: `false`)\_ Whether to use Code Assist for Moli Code model access instead of the default Moli Code API key.
  For more information, see the [Moli Code CLI documentation](https://github.com/dimoteo333/moli-code-action/blob/main/docs/cli/authentication.md).
...
- <a name="__input_use_pnpm"></a><a href="#user-content-__input_use_pnpm"><code>use*pnpm</code></a>: *(Optional, default: `false`)\_ Whether or not to use pnpm instead of npm to install moli-code-cli
...
- <a name="__output_summary"></a><a href="#user-content-__output_summary"><code>summary</code></a>: The summarized output from the Moli Code CLI execution.

- <a name="__output_error"></a><a href="#user-content-__output_error"><code>error</code></a>: The error output from the Moli Code CLI execution, if any.
...
This action requires authentication to the GitHub API and optionally to Moli Code services.
...
The Moli Code CLI can be extended with additional functionality through extensions.
...
Create a MOLI.md file in the root of your repository to provide
project-specific context and instructions to [Moli Code CLI](./common-workflow). This is useful for defining
...
[Moli Code]: https://github.com/dimoteo333/moli-code
[DashScope]: https://dashscope.console.aliyun.com/apiKey
[Moli Code CLI]: https://github.com/dimoteo333/moli-code-action/
[variables]: https://docs.github.com/en/actions/how-tos/write-workflows/choose-what-workflows-do/use-variables#creating-configuration-variables-for-a-repository
[GitHub CLI]: https://docs.github.com/en/github-cli/github-cli
[MOLI.md]: https://github.com/dimoteo333/moli-code-action/blob/main/docs/cli/configuration.md#context-files-hierarchical-instructional-context
