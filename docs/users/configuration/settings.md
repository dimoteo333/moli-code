...
In addition to a project settings file, a project's `.qwen` directory can contain other project-specific files related to Moli Code's operation, such as:
...
| `context.fileFiltering.respectQwenIgnore`         | boolean                    | Respect .moliignore files when searching.                                                                                                                                                                                                                                                                                                                             | `true`      |
