...
1. **DashScope** (Official, Free) - Automatically available for Moli OAuth users (200 requests/minute, 1000 requests/day)
...
- **Moli OAuth users:** DashScope is automatically added to your provider list, even if not explicitly configured
...
Pass API keys when running Moli Code:
...
**Note:** This setting requires a restart of Moli Code to take effect. Once disabled, the `web_search` tool will not be available to the model, even if web search providers are configured.
...
- **Cost:** Free
- **Authentication:** Automatically available when using Moli OAuth authentication
- **Configuration:** No API key required, automatically added to provider list for Moli OAuth users
- **Quota:** 200 requests/minute, 1000 requests/day
- **Best for:** General queries, always available as fallback for Moli OAuth users
- **Auto-registration:** If you're using Moli OAuth, DashScope is automatically added to your provider list even if you don't configure it explicitly
...
- **DashScope availability:** Automatically available for Moli OAuth users, no configuration needed
...
- **For Moli OAuth users:** The tool is automatically registered with DashScope provider, no configuration needed
