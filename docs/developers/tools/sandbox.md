...
#### 1、Clone qwen code project first, https://github.com/dimoteo333/moli-code.git
...
ls -la $(dirname $(which qwen))/../lib/node_modules/@moli-code/moli-code
...
- Official mirror image address:https://github.com/dimoteo333/moli-code/pkgs/container/moli-code

```bash
# Based on the official Qwen sandbox image (It is recommended to explicitly specify the version)
FROM ghcr.io/dimoteo333/moli-code:sha-570ec43
...
npm unlink -g @moli-code/moli-code
