...
This document describes the `save_memory` tool for Moli Code.

## Description

Use `save_memory` to save and recall information across your Moli Code sessions. With `save_memory`, you can direct the CLI to remember key details across sessions, providing personalized and directed assistance.
...
```
save_memory(fact="The project I'm currently working on is called 'moli-code'.")
```
