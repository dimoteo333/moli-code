...
- Added Gemini 2.5 Pro token limits (256K input, 32K output) and highres support
...
- Fixed authentication hang when selecting Moli OAuth.
- Added OpenAI and Moli OAuth authentication support to Zed ACP integration.
- Fixed output token limit for Gemini models.
...
- Added vision model support for Moli-OAuth authentication.
